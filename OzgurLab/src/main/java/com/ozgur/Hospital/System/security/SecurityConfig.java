    ...
    public SecurityFilterChain filterChain(HttpSecurity security, HandlerMappingIntrospector introspector) throws Exception{
        ...
        security
                ...
                .authorizeHttpRequests(x -> x
                        .requestMatchers(mvcRequestBuilder.pattern("/v1/patient/createPatient")).permitAll()
                        .requestMatchers(mvcRequestBuilder.pattern("/v1/laborant/createLaborantRequest")).permitAll()
